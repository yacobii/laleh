<div class="swiper homerslider">
    <div class="swiper-wrapper">
        <div class="swiper-slide relative">
            <img loading="lazy" class="w-full h-[70dvh] object-cover object-top" src="{{ asset('assets/slides/1.jpeg') }}"
                 alt="">
        ...
        <div class="swiper-slide relative">
            <img loading="lazy" class="w-full h-[70dvh] object-cover object-top" src="{{ asset('assets/slides/2.jpeg') }}"
                 alt="">
        ...
        <div class="swiper-slide relative">
            <img  loading="lazy" class="w-full h-[70dvh] object-cover object-top" src="{{ asset('assets/slides/3.jpeg') }}"
                 alt="">
